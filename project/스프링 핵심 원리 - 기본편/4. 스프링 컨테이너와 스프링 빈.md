...
#### 스프링 컨테이너의 생성 과정
<img src="2023-01-26-22-04-03.png" width = "100%" height = "100%"/>

* `new AnnotationConfigApplicationContext(AppConfig.class)`
* 스프링 컨테이너를 생성할 때는 구성 정보를 지정해주어야 한다.
* 여기서는 `AppConfig.class`를 구성 정보로 지정했다.

<img src="2023-01-26-22-08-13.png" width = "100%" height = "100%"/>
...
<img src="2023-01-26-22-12-06.png" width = "100%" height = "100%"/>
...
<img src="2023-01-26-22-19-17.png" width = "50%" height = "70%"/>
